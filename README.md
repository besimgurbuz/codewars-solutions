...
def nb_dig(n, d):
    ...
    return count
```
### [<4kyu> Connect Four: Who Won?](https://www.codewars.com/kata/529962509ce9545c76000afa)
...
### [<4kyu> Breadcrumb Generator](https://www.codewars.com/kata/563fbac924106b8bf7000046)
```javascript
/**
 *
 * @param {String} url
